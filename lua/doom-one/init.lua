...
doom_one.set_colorscheme = function()
  ...
  set_hl("CmpItemMenu", { fg = palette.fg, bg = "NONE" })
	...
	if config.plugins.bufferline then
		...
		set_hl("BufferLineErrorSelected", { link = "ErrorMsgBold" })
		set_hl("BufferLineWarningSelected", { link = "WarningMsgBold" })
		set_hl("BufferLineInfoSelected", { link = "MoreMsgBold" })
		set_hl("BufferLineHintSelected", { link = "MsgBold" })
		set_hl("BufferLinePick", { link = "ErrorMsgBold" })
		set_hl("BufferLinePickSelected", { link = "ErrorMsgBold" })
		set_hl("BufferLinePickVisible", { link = "ErrorMsgBold" })
