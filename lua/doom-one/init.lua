...
doom_one.set_colorscheme = function()
  ...
  set_hl("MatchWord", { link = "MatchParen" })
  set_hl("MatchWordCur", { link = "MatchParen" })
  ...
  if config.ui.enable_treesitter then
    ...
    set_hl("@markup.math.latex", { link = "@nospell" })
    ...
    -- org
    set_hl("@org.headline.level1.org", { link = "Attribute" })
    set_hl("@org.headline.level2.org", { link = "Attribute" })
    set_hl("@org.headline.level3.org", { link = "Attribute" })
    set_hl("@org.headline.level4.org", { link = "Attribute" })
    set_hl("@org.headline.level5.org", { link = "Attribute" })
    set_hl("@org.directive.org", { link = "Comment" })
    set_hl("@org.properties.org", { link = "Comment" })
    set_hl("@org.properties.name.org", { link = "Comment" })
  ...
  set_hl("RenderMarkdownH1", { link = "@markup.heading.1.markdown" })
  set_hl("RenderMarkdownH2", { link = "@markup.heading.2.markdown" })
  set_hl("RenderMarkdownH3", { link = "@markup.heading.3.markdown" })
  set_hl("RenderMarkdownH4", { link = "@markup.heading.4.markdown" })
  set_hl("RenderMarkdownH5", { link = "@markup.heading.5.markdown" })
  set_hl("RenderMarkdownH6", { link = "@markup.heading.6.markdown" })
  set_hl("RenderMarkdownH1Bg", { bg = palette.bg_alt })
  set_hl("RenderMarkdownH2Bg", { bg = palette.bg_alt })
  set_hl("RenderMarkdownH3Bg", { bg = palette.bg_alt })
  set_hl("RenderMarkdownH4Bg", { bg = palette.bg_alt })
  set_hl("RenderMarkdownH5Bg", { bg = palette.bg_alt })
  set_hl("RenderMarkdownH6Bg", { bg = palette.bg_alt })
